...
@section('content')
    @foreach ($plans as $plan)
        <div class="card">
            <div class="card-header card-title">Informações: {{ $plan->plan }}</div>
            <div class="card-body">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        <form action="{{ route('plano.destroy', $plan->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                    ...
                    <div class="form-group col-md-1">
                        <a href="{{ route('plano.edit', $plan->id) }}" class="btn btn-warning" title="Editar"> <i
