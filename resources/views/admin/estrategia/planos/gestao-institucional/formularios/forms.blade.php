...
<div class="form-row">
    <div class="form-group col-lg-3">
        ...
        <select name="type_plan_id" class="form-control">
            <option value="{{ $typePlan->id }}" selected readonly>{{ $typePlan->name }}</option>
        </select>
    </div>
</div>
...
<div class="form-row">
    <div class="form-group col-md-2">
        ...
        <a href="{{ route('setor.create') }}">Criar Setor</a>
    </div>
    ...
    <div class="form-group col-md-2">
        ...
        <input type="number" name="final_year" class="form-control"
            value="{{ $plan->final_year ?? old('final_year') }}" minlength='4' maxlength="4">
    </div>
...
<div class="form-row">
    <div class="form-group col-md-3">
        ...
        <input type="text" class="form-control" name="plan" value="{{ $plan->plan ?? old('plan') }}"
...
<div class="form-row">
    ...
    <div class="form-group btn-sm ml-1">
        <a href="{{ route('plano.index') }}" class="btn btn-outline-danger"><i class="fas fa-window-close"></i>
            Cancelar</a>
    </div>
</div>
