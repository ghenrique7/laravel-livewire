...
@section('content_header')
    <h1>Setores da Ufopa</h1>
    <a href="{{ route('setor.create') }}" class="btn btn-success"><i class="fas fa-plus-circle"></i> Setor</a>
@stop
...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <form action="{{ route('setor.search') }}" method="POST" class="form form-row">
                @csrf
                ...
                <tbody>
                    @foreach ($sectors as $sector)
                        <tr>
                            ...
                            <td class="align-middle"> {{ $sector->sector }} </td>
                            ...
                            <td class="align-middle">
                                ...
                                <div class="form-inline">
                                    <div class="form-group col-md-2">
                                        <a href="{{ route('setor.edit', $sector->id) }}" class="btn btn-warning btn-sm"> <i
                                                class="fas fa-solid fa-pen"></i></a>
                                    </div>
                                    <div class="form-group col-md-2 ">
                                        <form action="{{ route('setor.destroy', $sector->id) }}" method="POST"
